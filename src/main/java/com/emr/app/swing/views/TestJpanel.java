...
public class TestJpanel {
	...
	public static void start() {
		...
		lblNewLabel.setIcon(new ImageIcon(TestJpanel.class.getResource("/icons/breakfast.png")));
		...
		lblNewLabel_2.setIcon(new ImageIcon(TestJpanel.class.getResource("/icons/close.png")));
		lblNewLabel_2.setBounds(667, 12, 16, 16);
		desktopPane.add(lblNewLabel_2);

		JLabel lblNewLabel_3 = new JLabel("");
		lblNewLabel_3.setIcon(new ImageIcon(TestJpanel.class.getResource("/icons/user.png")));
		lblNewLabel_3.setBounds(384, 122, 16, 34);
		desktopPane.add(lblNewLabel_3);

		JLabel lblNewLabel_4 = new JLabel("");
		lblNewLabel_4.setIcon(new ImageIcon(TestJpanel.class.getResource("/icons/password.png")));
